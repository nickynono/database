...
public class StorageList {
	...
	public static void StorageList(final int buildNum, final Connection c) throws SQLException{
		...
		final JFrame frame = new JFrame("Storage List");
		frame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
		
		String quer = "EXECUTE getStorages";
		PreparedStatement s;
		s = con.prepareStatement(quer);
		rs = s.executeQuery();
		
		String quer2 = "EXECUTE getStorageCount";
		...
		String[] att = {"ID", "Name",
				"Type","3.5 Bay", "2.5 Bay", "Storage", "RPM", "Power",
		  ...
		  JButton addToBuildBut = new JButton("Add To Build");
		    addToBuildBut.addActionListener(new ActionListener(){
		     public void actionPerformed(ActionEvent arg0) {
		      ...
		      frame.dispose();
		      BuildMan.getBuild(buildNum).storage =new Integer(partID.getText());
		     }       
		   });

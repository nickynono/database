...
public class CaseList {
	...
	public static void CaseList(final int buildNum, final Connection c) throws SQLException{
		...
		final JFrame frame = new JFrame("Case List");
		frame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
		
		String quer = "EXECUTE getCases";
		PreparedStatement s;
		s = con.prepareStatement(quer);
		rs = s.executeQuery();
		
		String quer2 = "EXECUTE getCaseCount";
		...
		String[] att = {"ID", "Name",
				"Form","3.5 Bays","2.5 Bays","5.25 Bays",
				"MAX PSU","MAX GPU","MAX CPU COOLER",
		...
		delBut.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent arg0){
				DeleteCase.DeleteCase(buildNum, con);
			}
		});
		JButton addBut = new JButton("Add To List");
		addBut.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent arg0) {
				AddCase.AddCase(buildNum, con);			}  
	    });
		  ...
		  JButton addToBuildBut = new JButton("Add To Build");
		    addToBuildBut.addActionListener(new ActionListener(){
		     public void actionPerformed(ActionEvent arg0) {
		      ...
		      frame.dispose();
		      BuildMan.getBuild(buildNum).cse = new Integer(partID.getText());
		     }       
		   });

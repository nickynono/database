...
public class PSUList {
	...
	public static void PSUList(final int buildNum, final Connection c) throws SQLException{
		...
		final JFrame frame = new JFrame("PSU List");
		...
		String quer2 = "EXECUTE getPSUCount";
		...
		delBut.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent arg0){
				DeletePSU.DeletePSU(buildNum, con);
			}
		});
		JButton addBut = new JButton("Add To List");
		addBut.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent arg0) {
				AddPSU.AddPSU(buildNum, con);			}  
	    });
		  ...
		  JButton addToBuildBut = new JButton("Add To Build");
		    addToBuildBut.addActionListener(new ActionListener(){
		     public void actionPerformed(ActionEvent arg0) {
		      ...
		      frame.dispose();
		      BuildMan.getBuild(buildNum).PSU =new Integer(partID.getText());
		     }       
		   });

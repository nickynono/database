...
public class DeleteCPUCool {

	public static void DeleteCPUCool(int buildNum, Connection con){
		...
		System.out.println("Delete CPU Cooler");
		
		final JFrame frame = new JFrame("Delete CPU Cooler");

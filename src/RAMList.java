...
public class RAMList {
	...
	public static void RAMList(final int buildNum, Connection c) throws SQLException{
		...
		String quer = "EXECUTE getRAMs";
		PreparedStatement s;
		s = con.prepareStatement(quer);
		rs = s.executeQuery();
		
		String quer2 = "EXECUTE getRAMCount";
		...
		String[] att = {"ID", "Name",
				"Total GB","Stick GB","Stick Num","Pow",
		...
		delBut.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent arg0){
				DeleteRAM.DeleteRAM(buildNum, con);
			}
		});
		JButton addBut = new JButton("Add To List");
		addBut.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent arg0) {
				AddRAM.AddRAM(buildNum, con);			}  
	    });
		  ...
		  JButton addToBuildBut = new JButton("Add To Build");
		    addToBuildBut.addActionListener(new ActionListener(){
		     public void actionPerformed(ActionEvent arg0) {
		      ...
		      frame.dispose();
		      BuildMan.getBuild(buildNum).RAM = new Integer(partID.getText());
		     }       
		   });

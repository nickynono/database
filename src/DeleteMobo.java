...
public class DeleteMobo {

	public static void DeleteMobo(int buildNum, final Connection con){
		...
		System.out.println("Delete Motherboard");
		
		final JFrame frame = new JFrame("Delete Motherboard");
		...
		delBut.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent arg0) {
				...
				if(PIDTxt.getText().isEmpty()==true){
					...
					boolean added=true;
					String quer = "EXECUTE deleteMOBO ?";
					try {

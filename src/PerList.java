...
public class PerList {
	...
	public static void PerList(final int buildNum, final Connection c) throws SQLException{
		...
		final JFrame frame = new JFrame("Peripheral List");
		frame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
		
		String quer = "EXECUTE getPeripherals";
		PreparedStatement s;
		s = con.prepareStatement(quer);
		rs = s.executeQuery();
		
		String quer2 = "EXECUTE getPeripheralCount";
		...
		delBut.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent arg0){
				DeletePer.DeletePer(buildNum, con);
			}
		});
		JButton addBut = new JButton("Add To List");
		addBut.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent arg0) {
				AddPer.AddPer(buildNum, con);			}  
	    });
		  ...
		  JButton addToBuildBut = new JButton("Add To Build");
		    addToBuildBut.addActionListener(new ActionListener(){
		     public void actionPerformed(ActionEvent arg0) {
		      ...
		      frame.dispose();
		      BuildMan.getBuild(buildNum).Per1 = new Integer(partID.getText());
		     }       
		   });
